...
async function showLockScreen() {
  ...
  scrollContainer.style.cssText = `max-width:400px;width:100%;padding:20px;max-height:100vh;overflow-y:auto;`;
...
function confirmDisableSecurity() {
  ...
  localStorage.removeItem('SpendTrail-biometric-id');
  localStorage.removeItem('SpendTrail-security-asked');
